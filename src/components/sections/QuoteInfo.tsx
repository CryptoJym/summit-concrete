      ...
      <div className="space-y-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8 border-t-2 border-rebar/30">
          <div className="space-y-2 min-w-0">
            ...
            <p className="font-mono text-sm break-words">{brand.address}</p>
          </div>
          <div className="space-y-2 min-w-0">
            <h3 className="font-mono text-xs text-rebar uppercase font-bold">DIRECT LINE</h3>
            <a href={`tel:${brand.phone.replace(/[^0-9+]/g, "")}`} className="font-bold text-lg hover:text-primary transition-colors block break-words">
              {brand.phone}
            </a>
          ...
          <div className="space-y-2 min-w-0">
            ...
            <a href={`mailto:${brand.email}`} className="font-bold text-base sm:text-lg normal-case underline decoration-2 decoration-primary underline-offset-4 hover:text-primary transition-colors block break-all leading-snug">
              {brand.email}
            </a>
          </div>
          <div className="space-y-2 min-w-0">
